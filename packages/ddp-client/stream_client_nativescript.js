...
LivedataTest.ClientStream = class ClientStream {
  ...
  _launchConnection() {
    ...
    self._cleanup(); // cleanup the old socket, if there was one.
        ...
        // connection.
        var NativeWebSocket = Npm.require('faye-websocket').Client;
    ...
    var client = self.client = new NativeWebSocket(targetUrl, {
        timeout: __meteor_runtime_config__.nsSocketTimeout || 6000,
        allowCellular: true
    });
